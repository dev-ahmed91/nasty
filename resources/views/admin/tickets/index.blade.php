            ...
            <div class="card">
                <div class="card-body">
                    <div class="email-left-box px-0 mb-3">
                        <div class="p-0">
                            <a href="/assets/email-compose.html" class="btn btn-primary btn-block">Compose</a>
                        </div>
                        <div class="mail-list mt-4">
                            <a href="/assets/email-inbox.html" class="list-group-item active"><i
                                    class="fa fa-paper-plane font-18 align-middle mr-2"></i> Open Tickets <span
                                    class="badge badge-primary badge-sm float-right">198</span> </a>
                            <a href="javascript:void()" class="list-group-item"><i
                                    class="fa fa-star font-18 align-middle mr-2"></i>Pending Tickets <span
                                    class="badge badge-danger text-white badge-sm float-right">47</span>
                            </a>
                            <a href="javascript:void()" class="list-group-item"><i
                                    class="mdi mdi-file-document-box font-18 align-middle mr-2"></i>Closed Tickets</a><a href="javascript:void()" class="list-group-item"><i
                        ...
                        <div class="mail-list mt-4">
                            <a href="/assets/email-inbox.html" class="list-group-item">
                                <span class="icon-warning"><i class="fa fa-circle text-success" aria-hidden="true"></i></span>
                                Payment
                            </a>
                            <a href="/assets/email-inbox.html" class="list-group-item">
                                <span class="icon-primary"><i class="fa fa-circle text-black" aria-hidden="true"></i></span>
                                Registration
                            </a>
                            <a href="/assets/email-inbox.html" class="list-group-item">
                                <span class="icon-success"><i class="fa fa-circle text-warning" aria-hidden="true"></i></span>
                                Login
                            </a>
                            <a href="/assets/email-inbox.html" class="list-group-item">
                                <span class="icon-dpink"><i class="fa fa-circle text-primary" aria-hidden="true"></i></span>
                                Verification
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="email-list mt-3">
                            <div class="message">
                                <div>
                                    ...
                                    <a href="/assets/email-read.html" class="col-mail col-mail-2">
