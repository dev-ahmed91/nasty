            ...
            <div class="row">
                <div class="col-sm-6 col-md-3 mb-1">
                    <div class="input-group  search-area d-xl-inline-flex  mr-1" >
                        <input type="text" v-on:keyup.enter="fetchBranches()" class="form-control" placeholder="Search here..." v-model="q">
                        <div class="input-group-append">
                            <span class="input-group-text">
                                <a href="javascript:void(0)" v-on:click="fetchBranches()"><i class="flaticon-381-search-2"></i></a>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-1 col-sm-3 mb-1">
                    <div class="input-group  d-xl-inline-flex">
                        <a class="btn btn-primary" :href="route('admin.branches.create', {page: page})" title="New"><i class="la la-plus"></i></a>
                    </div>
                </div>
                ...
                <div class="col-md-2 col-sm-6 mb-1 ml-auto">
                    <div class="input-group search-area d-xl-inline-flex">
                            ...
                            <div class="dropdown-menu dropdown-menu-center">
                                <a v-for="branchSort in sorts" v-on:click="changeSort(branchSort)" class="dropdown-item" href="javascript:void(0);"><span :class="'text-'+branchSort.class">{{ branchSort.label }}</span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md text-small">
                            ...
                            <tbody>
                                <tr v-for="branch in branches.data">
                                    ...
                                    <td>{{ branch.name }}</td>
                                    <td>{{ moment(branch.created_at).format('DD MMM YYYY, hh:mm A') }}</td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" :href="route('admin.branches.edit', {branch: branch.id, page: page})">Edit</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <pagination :limit="8" :data="branches" :show-disabled="true" @pagination-change-page="fetchBranches">
